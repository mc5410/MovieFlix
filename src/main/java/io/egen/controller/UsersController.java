...
public class UsersController {
	...
	public Users createUser(@RequestBody Users user, HttpServletRequest request) throws UserAlreadyExitsException   {
	...
	@ApiOperation(value = "Find User by Email ID", notes = "Returns the User from the system with same Email ID.")
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Success"),
			@ApiResponse(code = 404, message = "User is not found in the system"),
			@ApiResponse(code = 500, message = "Internal Server Error") })
