		...
		<div class="login-screen">
 		...
 		<form id="loginForm"> 
				...
				<label class="login-field-icon fui-lock" for="password"></label>
								...
								<label id="message" class="msg">This User is not registered</label>								
								...
								<div>
							<p>New User ?   <a class="signup-link" href="index.jsp">Register</a></p>
								</div>
								
								<a class="login-link" href="index.jsp">Lost your password?</a>
				</form>
